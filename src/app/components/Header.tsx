          ...
          <div className="flex justify-between items-center py-3 md:py-4">
                ...
                {navigationItems.map((item) => (
                  <li key={item.href}>
                    <Button 
                      ...
                      size="md" 
                      asChild 
                      className="text-foreground/90 hover:text-foreground hover:bg-white/10 transition-all duration-300 font-medium text-base rounded-xl px-4 py-2 !rounded-xl overflow-hidden"
                    >
                      <Link href={item.href}>
                        {item.label}
                      </Link>
            ...
            <div className="flex md:hidden items-center gap-2 mobile-header-buttons">
              ...
              <Button
                ...
                className="p-2 bg-transparent hover:bg-white/10 border-0 shadow-none !rounded-xl overflow-hidden"
