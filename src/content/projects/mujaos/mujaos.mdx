...
![Alt text](/projects/mujaos/mujaos1.png)

### **Declarative. Modular. Reproducible.**

_A modern, flake-based NixOS configuration designed for clarity, maintainability, and reliability._
...
> 💡 _New to NixOS? Start with [Nix Pills](https://nixos.org/guides/nix-pills/) or the [NixOS Flakes Wiki](https://nixos.wiki/wiki/Flakes)._
